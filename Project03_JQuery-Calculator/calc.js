...
var calculator = function(displayContent) {
    ...
    this.compute = function() {
       ...
       //Exception Case06 - When an equalsButtons clicked without clicking the second operand and click the operand only and click equalsButton again
