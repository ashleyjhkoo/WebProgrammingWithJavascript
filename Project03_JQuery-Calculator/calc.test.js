...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 1, 'Incorrect value displayed when user enters single digit. Expected 1, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 23, 'Incorrect value displayed when user enters number consisting of multiple digits. Expected 23, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 4, 'Incorrect value displayed when user enters operand, then operator, then single-digit operand. Expected 4, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 56, 'Incorrect value displayed when user enters operand, then operator, then operand consisting of multiple digits. Expected 56, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 8, 'Incorrect value displayed when user attempts to add two single-digit operands. Expected 8, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 6, 'Incorrect value displayed when user attempts to subtract two single-digit operands. Expected 6, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 8, 'Incorrect value displayed when user attempts to multiply two single-digit operands. Expected 8, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 2, 'Incorrect value displayed when user attempts to divide two single-digit operands. Expected 2, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 35 + 28, 'Incorrect value displayed when user attempts to add two operands that each have multiple digits. Expected 35 + 28 = 63, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 67 - 41, 'Incorrect value displayed when user attempts to subtract two operands that each have multiple digits. Expected 67 - 41 = 26, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 19 * 20, 'Incorrect value displayed when user attempts to multiply two operands that each have multiple digits. Expected 19 * 20 = 380, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 5, 'Incorrect value displayed when user attempts to divide two operands that each have multiple digits. Expected 5, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 10, 'Incorrect value displayed when user enters an operand, an operator, an operand, and then clicks add button. Expected 10, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 13, 'Incorrect value displayed when user enters an operand, an operator, an operand, and then clicks subtract button. Expected 13, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 14, 'Incorrect value displayed when user enters an operand, an operator, an operand, and then clicks multiply button. Expected 14, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 6, 'Incorrect value displayed when user enters an operand, an operator, an operand, and then clicks divide button. Expected 6, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 15 + 32 + 6, 'Incorrect value displayed when user tries to perform two add operations without clicking equals button in between. Expected 15 + 32 + 6 = 53, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 90 - 18 - 7, 'Incorrect value displayed when user tries to perform two subtract operations without clicking equals button in between. Expected 90 - 18 - 7 = 65, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 5 * 23 * 87, 'Incorrect value displayed when user tries to perform two multiply operations without clicking equals button in between. Expected 5 * 23 * 87 = 10005, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 3, 'Incorrect value displayed when user tries to perform two divide operations without clicking equals button in between. Expected 3, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 7 + 6 + 5, 'Incorrect value displayed when user performs operation, clicks equals button, then add, then another operator, then equals button again. Expected 7 + 6 + 5 = 18, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, (9 + 3) - 4, 'Incorrect value displayed when user performs operation, clicks equals button, then subtract, then another operator, then equals button again. Expected 9 + 3 - 4 = 8, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, (2 + 1) * 8, 'Incorrect value displayed when user performs operation, clicks equals button, then multiply, then another operator, then equals button again. Expected (2 + 1) * 8 = 24, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 2, 'Incorrect value displayed when user performs operation, clicks equals button, then divide, then another operator, then equals button again. Expected 2, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, -5, 'Incorrect value displayed when result of subtraction is negative. Expected -5, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, -7, 'Incorrect value displayed after user enters 0, then subtract, then another operand. Expected -7, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, '', 'Display should be clear after entering number and then hitting clear button. Expected blank (""), received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, '', 'Display should be clear after clicking clear button after performing operation. Expected blank (""), received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 9, 'Incorrect value displayed after entering operand, then clicking equals button before operator and second operand. Expected 9, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 12, 'Incorrect value displayed after choosing an operator and then clicking equals button before entering second operand. Expected 12, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 21, 'Incorrect value displayed after choosing one operator then another before entering second operand. Expected 21, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
...
horseman
    ...
    .value("#display")
    .then(function (value) {
	    assert.equal(value, 13, 'Incorrect value displayed after performing operation and hitting equals button twice. Expected 13, received ' + value);
	})
    .then( () => { horseman.close(); })
    .then(done, done);
}
